...
export const metadata: Metadata = {
  ...
  description:
    "Press kit and media resources for Apprehension play. Download press releases, production photos, and contact information for media inquiries.",
  keywords:
    "Apprehension press kit, media resources, press release, production photos, theatre press materials, L.B. Deyo press",
  openGraph: {
    title: "Press Kit | Apprehension Play - Media Resources",
    description:
      "Media resources and press materials for the psychological thriller Apprehension. Download press releases and production photos.",
    url: "https://apprehensionplay.com/press-kit",
    images: [
      {
        url: "/meta-image.jpg",
        width: 1200,
        height: 630,
        alt: "Apprehension Press Kit - Media Resources",
      },
    ],
    type: "website",
  },
  twitter: {
    ...
    title: "Press Kit | Apprehension Play - Media Resources",
    description:
      "Media resources and press materials for the psychological thriller Apprehension.",
