...
export default function MediaGallery() {
  ...
  const mediaItems = [
    ...
    { type: "image" as const, src: "/img/bts/rehearsal-1-bts/rh1a.jpg" },
    { type: "image" as const, src: "/img/bts/rehearsal-1-bts/rh1b.jpg" },
    { type: "image" as const, src: "/img/bts/rehearsal-1-bts/rh1c.jpg" },
    { type: "image" as const, src: "/img/bts/rehearsal-1-bts/rh1d.jpg" },
    ...
    {
      type: "image" as const,
      src: "/img/media/apprehension-poster-concept-1.jpg",
    },
    {
      type: "image" as const,
      src: "/img/media/apprehension-poster-concept-3.jpg",
    },
  ];
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div
        className="absolute inset-0 w-full h-full bg-contain bg-top bg-no-repeat z-0"
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto space-y-12 pt-20 pb-16 text-left px-4 sm:px-6 lg:px-8">
        ...
        <section className="space-y-4 text-left">
          <div className="relative w-full max-w-max">
            <h1
              className="text-6xl md:text-9xl lg:text-9xl text-white mt-6 md:mt-5 inline-block"
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6">
            {mediaItems.map((item, index) => (
              ...
              >
                <img
                  src={item.src}
                  alt="Media content from Apprehension play"
          ...
          >
            ...
            >
              {selectedMedia.type === "video" ? (
                ...
                <img
                  src={selectedMedia.src}
                  alt="Enlarged media from Apprehension play"
