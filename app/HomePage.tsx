  ...
  return (
    <span
      ...
      style={
        animate
          ? {}
          : { display: "inline-block", transform: "translateX(-100vw)" }
      }
    >
      {children}
    </span>
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto space-y-12 pt-20 pb-16 text-left px-4 sm:px-6 lg:px-8">
        ...
        <section className="space-y-4 text-left">
          ...
          <div className="relative w-full max-w-max">
            ...
            <p
              className="text-2xl md:text-4xl text-white text-right ml-auto opacity-0 animate-fade-in"
              style={{
          ...
          >
            <div
              className="p-5   border-r border-t border-[#BEB58F] md:max-w-[50%] text-[#cdc49b] text-2xl md:text-3xl mb-0 "
              style={{ textShadow: "1px 2px 4px rgba(0,0,0,0.9)" }}
            >
              <p className="md:my-2">Directed by Sonnet Blanton</p>
              <p className="md:my-2">Produced by Christopher Shea</p>
            </div>
            <div
          ...
          <div className="text-white text-xl md:text-2xl md:max-w-[70%]">
            ...
            >
              <i>Apprehension</i> is a paranoid psychological thriller about Joe
              Dempsey, a man tormented by memory lapses and gnawing doubts about
              his own past. During a period of emotional collapse, Joe begins to
              suspect that his wife and friends are not who they seem to be. As
              his grasp on reality wavers, he struggles to determine whether
              he's uncovering a horrific truth or falling prey to delusion. Set
              in a world of shifting loyalties, buried traumas, and eerie
              disappearances, <i>Apprehension</i> explores the line between
              paranoia and insight.
            </p>
          </div>
          <div className="md:max-w-[50%] mt-10 border border-white border-2 flex flex-col shadow-lg opacity-0 animate-fade-in">
            ...
            <div className="flex flex-row">
              <div className="border-r-2 border-black p-2 flex items-center ">
                <Image
                  src="/img/danger-symbol.svg"
                  alt="Warning danger symbol"
                  width={100}
                  height={100}
                />
              </div>
              <div className="text-white p-4 ps-5 flex-1 flex items-center bg-[#a7a082]/80">
                <p className=" text-4xl  text-black">
                  {" "}
                  WARNING: Risk of Heart Attack, Shock, Death
                </p>
              </div>
            </div>
            ...
            <div className=" p-4 text-black text-lg border-t-2 border-black bg-[#a7a082]/80">
              <p className="text-xl  text-black">
                <i>Apprehension</i> contains extremely disturbing themes and
                depicts horrifying events. The viewer is advised to proceed with
                caution. Consult your physician before attending.
              </p>
            </div>
          </div>
        </section>
